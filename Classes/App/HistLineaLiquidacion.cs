...
[Serializable]
public partial class HistLineaLiquidacion
{
    [JsonPropertyName("id_hist_linea_liquidacion")]
    public int IdHistLineaLiquidacion { get; set; }

    [JsonPropertyName("hist_cabecera_liquidacion_id")]
    public int HistCabeceraLiquidacion_id { get; set; }
