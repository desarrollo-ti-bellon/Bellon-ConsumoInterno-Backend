...
[Serializable]
public partial class HistCabeceraTransito
{
    [JsonPropertyName("id_hist_cabecera_transito")]
    public int? IdHistCabeceraTransito { get; set; }
    ...
    public List<HistLineaTransito>? Lineas { get; set; }
}
