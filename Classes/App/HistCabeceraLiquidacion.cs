...
[Serializable]
public partial class HistCabeceraLiquidacion
{
    [JsonPropertyName("id_hist_cabecera_liquidacion")]
    public int IdHistCabeceraLiquidacion { get; set; }
    ...
    public List<HistLineaLiquidacion>? Lineas { get; set; }

    [JsonPropertyName("cargos")]
    public List<HistCargoAdicional>? Cargos { get; set; }
}
