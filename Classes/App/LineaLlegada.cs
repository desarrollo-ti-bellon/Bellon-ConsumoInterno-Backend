...
[Serializable]
public partial class LineaLlegada
{
    [JsonPropertyName("id_linea_llegada")]
    public int? IdLineaLlegada { get; set; }

    [JsonPropertyName("cabecera_llegada_id")]
    public int CabeceraLlegadaId { get; set; }
